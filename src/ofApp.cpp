...
void ofApp::loadSounds()
{
    ...
    strike00_sound.loadSound("./GameSounds/strike.wav");
...
void ofApp::setup(){
   ...
   // ofSetFullscreen(true);
    ...
    initial_image.loadImage("StartScreen.png");
    ...
    win_vid.loadMovie("Jellyfish.mp4");
}
...
void ofApp::update(){
    ...
    {
        intensity = strikeCount * 0.01 + 0.005;
    }
    float duration = 0.5f;
...
void ofApp::draw(){
    ...
    {
        initial_image.draw(0, 0, 1024, 768);
    }*/
    else if (state == WIN)
    {
        win_vid.draw(0, 0, 1024, 768);
    }
    else
    {
...
void ofApp::keyPressed(int key){
    ...
    switch(key)
    {
        case ' ':
            ...
            if (ofGetElapsedTimef() - touchStartTime > TOUCH_COOLDOWN && (state != WIN))
            {
